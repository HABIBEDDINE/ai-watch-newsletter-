...
const SECTOR_COLORS = {
  ...
  HealthTech:    { bg: "var(--topic-healthtech-bg)",    color: "var(--topic-healthtech)" },
  Cybersecurity: { bg: "var(--topic-cybersecurity-bg)", color: "var(--topic-cybersecurity)" },
  CleanTech:     { bg: "var(--topic-cleantech-bg)",     color: "var(--topic-cleantech)" },
  Robotics:      { bg: "var(--topic-robotics-bg)",      color: "var(--topic-robotics)" },
  General:       { bg: "var(--surface)",                color: "var(--text-muted)" },
};
...
function Toast({ t }) {
  ...
  return (
    <div style={{
      ...
      background: "var(--card-bg)", border: `1px solid ${ok ? "var(--green)" : "var(--orange)"}`,
      borderLeft: `4px solid ${ok ? "var(--green)" : "var(--orange)"}`,
...
function StepBar({ step, selectedCount }) {
  const steps = [
    { n: 1, label: "Select Articles", sub: `${selectedCount} selected` },
          ...
          <div key={s.n} style={{ display: "flex", alignItems: "center", flex: i < 2 ? 1 : "none" }}>
            <div style={{
              ...
              <div style={{
                ...
                background: done ? "var(--green)" : active ? "var(--orange)" : "var(--border-color)",
...
function Section({ title, defaultOpen = true, children }) {
  ...
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      >
        <span style={{ fontSize: 11, fontWeight: 800, color: "var(--text-muted)", letterSpacing: 1.2, textTransform: "uppercase" }}>{title}</span>
...
function LivePreview({ articles, config, selectedIds, recipients }) {
  ...
  return (
    <div style={{
      ...
      {/* Preview header */}
      <div style={{ background: "#1A1A2E", color: "#fff", padding: "12px 16px", flexShrink: 0 }}>
            ...
            <div key={grp} style={{ marginBottom: 14 }}>
              ...
              {grpArticles.map((a, i) => (
                <div key={i} style={{
                  ...
                  <div style={{ fontSize: 9, color: "var(--text-muted)", lineHeight: 1.4, marginBottom: 4 }}>
      ...
      {/* Preview footer */}
      <div style={{
        background: "#1A1A2E", padding: "10px 16px", flexShrink: 0,
        display: "flex", alignItems: "center", justifyContent: "space-between",
      }}>
...
export default function NewsletterPage() {
  ...
  const pill = (active) => ({
    ...
    border: `1.5px solid ${active ? "var(--orange)" : "var(--border-color)"}`,
    background: active ? "var(--orange-light)" : "var(--card-bg)",
    color: active ? "var(--orange)" : "var(--text-muted)", transition: "all 0.15s",
  });
            ...
            {step === 1 && (
              <div>
                ...
                <div style={{
                  ...
                  marginBottom: 16, padding: "12px 16px", background: "var(--card-bg)",
                  borderRadius: 10, border: "1px solid var(--border-color)",
                }}>
                  <span style={{ fontSize: 11, fontWeight: 700, color: "var(--text-muted)", marginRight: 4 }}>TOPIC</span>
                  {TOPICS.map(t => (
                    <button key={t} style={pill(topicFilter === t)} onClick={() => setTopicFilter(t)}>{t}</button>
                  ))}
                  <div style={{ width: 1, height: 20, background: "var(--border-color)", margin: "0 4px" }} />
                  <span style={{ fontSize: 11, fontWeight: 700, color: "var(--text-muted)" }}>SIGNAL</span>
                  ...
                  {!articlesLoading && articles.length === 0 && (
                    <div style={{
                      ...
                      <div style={{ fontSize: 13, color: "var(--text-muted)", marginBottom: 16 }}>
                        Go to News Feed and click "Refresh Intelligence" first, then come back.
                      </div>
                    </div>
                  )}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{
                          ...
                          border: `2px solid ${sel ? "var(--orange)" : "var(--border-color)"}`,
                          background: sel ? "var(--orange)" : "var(--card-bg)",
                          display: "flex", alignItems: "center", justifyContent: "center",
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ display: "flex", flexWrap: "wrap", gap: 6, alignItems: "center" }}>
                            {source && (
                              <span style={{ fontSize: 10, color: "var(--text-muted)", fontWeight: 600 }}>{source}</span>
                            )}
                            {topic && (
                              <span style={{
              ...
              <div style={{ maxWidth: 580 }}>
                ...
                <div style={{ background: "var(--card-bg)", borderRadius: 12, padding: "20px 24px", border: "1px solid var(--border-color)" }}>
                  ...
                  <Section title="Style">
                    ...
                    <SelectRow label="Group articles by" value={config.groupBy} options={["Sector", "Date", "No grouping"]} onChange={v => cfg("groupBy", v)} />
                  </Section>
            ...
            {step === 3 && (
              <div style={{ maxWidth: 580 }}>
                ...
                {sendTab === "schedule" && (
                  <div style={{ background: "var(--card-bg)", borderRadius: 12, padding: 24, border: "1px solid var(--border-color)" }}>
                    <div style={{ marginBottom: 20 }}>
                      <label style={{ fontSize: 11, fontWeight: 700, color: "var(--text-muted)", letterSpacing: 1, textTransform: "uppercase", display: "block", marginBottom: 10 }}>
                        Days
                      </label>
                        ...
                        {DAYS.map(d => {
                          ...
                          return (
                            <button key={d} onClick={() => {
                              ...
                              background: on ? "var(--orange-light)" : "var(--card-bg)",
                              color: on ? "var(--orange)" : "var(--text-muted)", cursor: "pointer",
                            }}>{d}</button>
                          );
                        })}
                      </div>
                    ...
                    <div style={{ display: "flex", gap: 16, marginBottom: 20, flexWrap: "wrap" }}>
                      <div>
                        <label style={{ fontSize: 11, fontWeight: 700, color: "var(--text-muted)", letterSpacing: 1, textTransform: "uppercase", display: "block", marginBottom: 8 }}>Time (UTC)</label>
                      ...
                      <div>
                        <label style={{ fontSize: 11, fontWeight: 700, color: "var(--text-muted)", letterSpacing: 1, textTransform: "uppercase", display: "block", marginBottom: 8 }}>Frequency</label>
                    ...
                    {schedule.days.length > 0 && (
                      <div style={{
                        background: "var(--surface)", border: "1px solid var(--border-color)", borderRadius: 8,
                        padding: "10px 14px", marginBottom: 20, fontSize: 12, color: "var(--text-muted)",
                      }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: 28 }}>
              <button
                ...
                style={{
                  ...
                  padding: "10px 24px", fontSize: 13, fontWeight: 700, color: "var(--text-muted)",
